...
class RR(nn.Module):
    def __init__(self,in_ch,inc_ch):
        ...
        self.conv_out = nn.Conv2d(385,1,3,padding=1)
...
class TriFuse(nn.Module):
    def __init__(self,pretrained=False):
        ...
        self.backbone1 = Res2Net_model(ind=50)
        ...
        self.msd1 = MSD(in_channels=256, out_channels=128)
        self.msd2 = MSD(in_channels=512, out_channels=256)
        self.msd3 = MSD(in_channels=1024, out_channels=512)
        self.msd4 = MSD(in_channels=2048, out_channels=1024)

        self.ciq1 = CrossIQ(in_channels=128, out_channels=64)
        self.ciq2 = CrossIQ(in_channels=256, out_channels=128)
        self.ciq3 = CrossIQ(in_channels=512, out_channels=256)
        self.ciq4 = CrossIQ(in_channels=1024, out_channels=512)
    ...
    def forward(self, rgb, t, d):
        score_list_t = self.backbone1(t)
        score_list_rgb = self.backbone1(rgb)
        score_list_d = self.backbone1(d)
