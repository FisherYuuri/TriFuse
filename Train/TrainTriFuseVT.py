...
if __name__ == '__main__':
    ...
    img_root = './dataset/VT1000/Train/'
    data = VTData(img_root)
    ...
    for epochi in tqdm(range(0, epoch + 1)):
        ...
        while rgb is not None:
            ...
            x1e_pred, x1e_pred_t, x_pred, x_refine = net(rgb, t)
            ...
            sal_loss = (loss0 * 2 + loss1 + loss2 + loss4 + loss5 + loss6 + loss7 + loss_x4eg + loss_x3eg + loss_x2eg + loss_x1eg + loss_x0eg * 2)
